...
\begin{figure}[ht!]
	\centering
	\subfloat[A FlashBoost Rack]
		{\includegraphics[width=0.23\textwidth]{figures/rackserver2.jpg}}
	\subfloat[A FlashBoost Rack Node]
		{\includegraphics[width=0.23\textwidth]{figures/racknode.jpg}}
	\caption{A 20-Node FlashBoost Cluster}
	\label{fig:bluedbmcluster}
\end{figure}
