...
BDBM_ID=3 ./bin/bsim_exe 2>&1 | tee ../bsim_exe1.txt & bsimexe1=$1
cd ..


cd bluesim2
./bin/bsim 2>&1 | tee ../bsim2.txt & bsim2=$!
BDBM_ID=4 ./bin/bsim_exe 2>&1 | tee ../bsim_exe2 & bsimexe2=$1
cd ..

cd bluesim3
./bin/bsim 2>&1 | tee ../bsim3.txt & bsim3=$!
BDBM_ID=5 ./bin/bsim_exe 2>&1 | tee ../bsim_exe3 & bsimexe3=$1
cd ..

cd bluesim4
./bin/bsim 2>&1 | tee ../bsim4.txt & bsim4=$!
BDBM_ID=6 ./bin/bsim_exe 2>&1 | tee ../bsim_exe4 & bsimexe4=$1
cd ..
